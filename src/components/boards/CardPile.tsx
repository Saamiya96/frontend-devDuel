...
const hudContainer =
  "hud-container flex flex-col items-center space-y-1 w-auto";
...
const wormholeArt =
  "wormhole-art w-48 absolute fixed top-80 mix-blend-color-exclusion";
const wormholeOverlay =
  "wormhole-art w-48 absolute fixed top-80 mix-blend-color-dodge";
const blackHoleCount =
  "black-hole-count text-2xl font-bold text-white p-3 w-36 text-center bg-gradient-to-b from-indigo-500";
const cardPileContainer =
  "card-pile-container flex flex-col items-center space-y-1 text-center bg-gradient-to-t from-red-500 p-4 hover:bg-blue-600";
      ...
      <div className={HUD}>
        <div className={deckDisplay}>
          <div className={wormholeContainer}>
            <div>
              <img
                src="/src/assets/Images/wormhole_crack.png"
                alt="Wormhole"
                className={wormholeArt}
              />
              <img
                src="/src/assets/Images/wormhole_crack.png"
                alt="Wormhole"
                className={wormholeOverlay}
              />
            </div>
          ...
          <div className={cardPileContainer}>
            ...
            <p>
              Your Deck:<br></br> {cardsInDeck} cards
            </p>
          </div>
        </div>
      </div>
